...
public sealed class RandomXoshiro256PlusPlus : RandomNumberGeneratorBase
{
	...
	public RandomXoshiro256PlusPlus()
	{
	...
	public RandomXoshiro256PlusPlus(ulong s0, ulong s1, ulong s2, ulong s3)
	{
		_s0 = s0;
		_s1 = s1;
		_s2 = s2;
